class BinaryTree{
    public static void main(String[] a){
        ...
        System.out.println(new BT().Start(20,"",true));
...
class BT {
    ...
    void testVoid(int n, String s, boolean b, char c, int[] arr, Tree t ){
    	int m;
    	String str;
    	char ch;
    	boolean bl;
	...
	int Start(int a, String s,boolean b){
        Tree root ;
        boolean ntb ;
        int nti ;
